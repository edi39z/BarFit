...
fun SignupPage(modifier : Modifier = Modifier, navController: NavController, authViewModel: AuthViewModel){
    ...
    Column(
        ...
        Text(text = "Create Your Account", fontSize = 30.sp)
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            TextButton(
                ...
                contentPadding = PaddingValues(0.dp),  // Menghapus padding bawaan pada TextButton
                modifier = Modifier.padding(start = 0.dp) // Mengatur jarak kecil antara teks dan tombol
            ) {
